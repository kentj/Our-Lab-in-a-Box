...
The script can be found at https://raw.githubusercontent.com/kentj/Our-Lab-in-a-Box/main/scripts/script.py[].  Use curl or wget from the CLI of the docker server named remote.
